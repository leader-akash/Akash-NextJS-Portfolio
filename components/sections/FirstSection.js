...
import author from '../../public/png/akash.png'
        ...
        <section className={styles.container} id='section1' style={{ marginBottom: load ? '8em' : '0' }}>
            <div ref={leftCol} className={styles.left_col} id="leftCol">
                <div className={styles.intro_con}>
                    ...
                    <a target="_blank" rel='noreferrer' href="https://drive.google.com/file/d/1ChU3LaHUPNHfVygt2ETgoISYgGJLPgN9/view?usp=sharing" id="resume">Resume</a>
